...
<h3>Computer Science Student | Frontend Developer 🌐</h3>
...
const daliaAli = {
  ...
  education: "Computer Science - Faculty of Science",
  skills: ["HTML", "CSS", "JavaScript", "Git", "GitHub"],
  tools: ["VS Code", "Figma"],
  learning: ["React", "UI/UX", "Modern JavaScript"],
  goals: "Build real-world frontend projects 🚀"
};
